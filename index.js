...
let pursuanceNames = ['The Free Insulin Project', 'Oakland BioHackers', 'Silicon Valley Foundation', 'EFF', 'Indymedia', 'Free as in Freedom', 'burners4biojustice', 'Omni Commons', 'Noisebridge', 'Hacker Moms', 'Ministry of Truth', 'Berkeley Free Clinic', 'Biohackers Buenos Aires']
// set initial main pursuance name
d3.selectAll('.pursuance-name').text(pursuanceNames[0])
...
const attachListeners = function () {
  ...
  d3.select('#main-pursuance-event-catcher')
    .on('mouseenter', function (d) {
      ...
      d3.selectAll('.pursuance-name').text(d.pursuanceName)
